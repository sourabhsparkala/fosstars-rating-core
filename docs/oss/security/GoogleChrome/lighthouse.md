...
**Score**: **5.64**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **3.4** (weight is 1.0)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/GoogleChrome/lighthouse)
5.  You can open a pull request to add a security policy for the project.
    ...
    3.  [Suggest a security policy for the project](https://github.com/GoogleChrome/lighthouse/security/policy)
...
Score: **3.4**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  Number of stars for a GitHub repository: **22450**
1.  Number of watchers for a GitHub repository: **545**
