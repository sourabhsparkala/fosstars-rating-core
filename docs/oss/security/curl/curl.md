...
1.  **[Security testing](#security-testing)**: **6.71** (weight is 1.0)
...
1.  Info about vulnerabilities: **71 vulnerabilities, [details below](#known-vulnerabilities)**
...
326 commits in the last 3 months results to 10.00 points
