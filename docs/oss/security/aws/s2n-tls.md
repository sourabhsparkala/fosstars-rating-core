...
**Score**: **5.51**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **3.57** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **4.56** (weight is 0.5)
...
Score: **3.57**, confidence is 10.0 (max), weight is 1.0 (high)
...
146 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **146**
1.  Number of contributors in the last three months: **1**

### Project popularity

Score: **4.56**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **3963**
