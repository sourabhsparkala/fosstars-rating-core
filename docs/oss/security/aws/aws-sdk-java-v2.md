...
**Score**: **5.11**, max score value is 10.0
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/aws/aws-sdk-java-v2)
...
635 commits in the last 3 months results to 10.00 points
10 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **635**
...
1.  Number of stars for a GitHub repository: **1163**
