...
**Score**: **5.48**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **4.2** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **7.48** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/aws/aws-sdk-js)
...
Score: **4.2**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **7.48**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **6630**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **RUBY, JAVASCRIPT, TYPESCRIPT, OTHER**
