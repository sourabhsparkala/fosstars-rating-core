...
**Score**: **6.22**, max score value is 10.0
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/aws/aws-cli)
...
1.  Number of stars for a GitHub repository: **11172**
1.  Number of watchers for a GitHub repository: **569**
