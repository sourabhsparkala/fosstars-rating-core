...
1.  **[Project popularity](#project-popularity)**: **3.77** (weight is 0.5)
...
Score: **3.77**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **3274**
1.  Number of watchers for a GitHub repository: **148**
