...
**Score**: **5.33**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **5.0** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **1.66** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/aws/copilot-cli)
...
229 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **229**
1.  Number of contributors in the last three months: **1**

### Project popularity

Score: **1.66**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1518**
1.  Number of watchers for a GitHub repository: **43**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **JAVASCRIPT, GO, OTHER**
