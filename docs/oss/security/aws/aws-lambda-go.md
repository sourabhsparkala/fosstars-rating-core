...
**Score**: **3.34**, max score value is 10.0
...
Score: **2.86**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **2651**
1.  Number of watchers for a GitHub repository: **62**
