...
1.  **[Project popularity](#project-popularity)**: **1.38** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/aws/jsii)
...
1.  Number of stars for a GitHub repository: **1236**
