...
**Score**: **3.89**, max score value is 10.0
...
5.  You can configure Dependabot by creating a configuration file.
    More info:
...
1.  Number of stars for a GitHub repository: **1407**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **PHP, OTHER**
