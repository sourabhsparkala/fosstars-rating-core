...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/aws/lumberyard)
...
1.  Number of stars for a GitHub repository: **1515**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **C, CPP, JAVA, C_SHARP, PYTHON, JAVASCRIPT, TYPESCRIPT, OTHER**
