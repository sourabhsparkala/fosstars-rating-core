...
1.  **[Security testing](#security-testing)**: **1.67** (weight is 1.0)
...
1.  **[Project activity](#project-activity)**: **3.38** (weight is 0.5)
1.  **[Project popularity](#project-popularity)**: **9.07** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/aws/serverless-application-model)
...
Score: **1.67**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **3.38**, confidence is 10.0 (max), weight is 0.5 (medium)
...
Score: **9.07**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **7995**
1.  Number of watchers for a GitHub repository: **323**
