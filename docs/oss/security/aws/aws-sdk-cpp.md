...
1.  **[Security testing](#security-testing)**: **3.78** (weight is 1.0)
    ...
    1.  **[Memory-safety testing](#memory-safety-testing)**: **7.0** (weight is 1.0)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/aws/aws-sdk-cpp)
...
9.  You can add OWASP Dependency Check to the project's build pipeline.
    More info:
...
10.  You can set a CVSS threshold for vulnerabilities reported by OWASP Dependency Check.
    More info:
    1.  [OWASP Dependnecy Check](https://jeremylong.github.io/DependencyCheck/)
...
Score: **3.78**, confidence is 10.0 (max), weight is 1.0 (high)
...
121 commits in the last 3 months results to 10.00 points
4 contributors increase the score value from 10.00 to 11.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **121**
...
1.  Number of stars for a GitHub repository: **1259**
