...
1.  **[Project activity](#project-activity)**: **0.81** (weight is 0.5)
...
Score: **0.81**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

5 commits in the last 3 months results to 0.77 points
2 contributors increase the score value from 0.77 to 0.81
...
1.  Number of stars for a GitHub repository: **3758**
1.  Number of watchers for a GitHub repository: **709**
