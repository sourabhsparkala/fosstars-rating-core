...
**Score**: **5.78**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **7.6** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/aws/aws-cdk)
...
560 commits in the last 3 months results to 10.00 points
8 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **560**
1.  Number of contributors in the last three months: **8**

### Project popularity

Score: **7.6**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **6920**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **JAVA, C_SHARP, F_SHARP, PYTHON, JAVASCRIPT, TYPESCRIPT, GO, OTHER**
