...
**Score**: **3.54**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **2.33** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **1.44** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/aws/opsworks-cookbooks)
...
Score: **2.33**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **1.44**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1058**
1.  Number of watchers for a GitHub repository: **116**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **RUBY, PYTHON, JAVASCRIPT, OTHER**
