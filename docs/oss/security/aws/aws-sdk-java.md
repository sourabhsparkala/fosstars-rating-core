...
**Score**: **5.22**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **4.62** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/aws/aws-sdk-java)
...
1.  Number of stars for a GitHub repository: **3557**
