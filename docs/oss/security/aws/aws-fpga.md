...
1.  **[Security testing](#security-testing)**: **1.0** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **2.05** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/aws/aws-fpga)
...
Score: **2.0**, confidence is 9.41 (high), weight is 0.9 (high)
...
Score: **2.05**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1126**
