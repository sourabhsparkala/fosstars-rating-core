...
1.  **[Security testing](#security-testing)**: **0.29** (weight is 1.0)
...
Score: **0.29**, confidence is 10.0 (max), weight is 1.0 (high)
...
100 commits in the last 3 months results to 10.00 points
8 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **100**
...
1.  Number of stars for a GitHub repository: **4973**
1.  Number of watchers for a GitHub repository: **235**
