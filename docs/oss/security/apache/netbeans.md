...
**Score**: **4.59**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **1.33** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **2.15** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/netbeans)
...
Score: **1.33**, confidence is 10.0 (max), weight is 1.0 (high)
...
367 commits in the last 3 months results to 10.00 points
25 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **367**
1.  Number of contributors in the last three months: **25**

### Project popularity

Score: **2.15**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1619**
1.  Number of watchers for a GitHub repository: **160**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **C, CPP, JAVA, PHP, JAVASCRIPT, TYPESCRIPT, OTHER**
...
1.  Does it use nohttp? **No**
1.  Package managers: **MAVEN, GRADLE, NPM, YARN, COMPOSER**
