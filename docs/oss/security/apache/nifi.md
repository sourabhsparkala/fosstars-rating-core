...
**Score**: **5.85**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **3.29** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/nifi)
...
1.  Info about vulnerabilities: **27 vulnerabilities, [details below](#known-vulnerabilities)**
...
16 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **206**
1.  Number of contributors in the last three months: **16**

### Project popularity

Score: **3.29**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **2677**
1.  Number of watchers for a GitHub repository: **183**
