...
**Score**: **6.01**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **5.92** (weight is 1.0)
    ...
    1.  **[Static analysis](#static-analysis)**: **4.8** (weight is 1.0)
        ...
        1.  **[FindSecBugs score](#findsecbugs-score)**: **10.0** (weight is 0.5)
...
1.  **[Project popularity](#project-popularity)**: **1.47** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/logging-log4j2)
...
Score: **5.92**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **1.47**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1211**
1.  Number of watchers for a GitHub repository: **77**
