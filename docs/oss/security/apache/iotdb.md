...
**Score**: **4.94**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **1.68** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/iotdb)
...
Score: **1.68**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1401**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **CPP, JAVA, SCALA, PYTHON, JAVASCRIPT, OTHER**
