...
1.  **[Project popularity](#project-popularity)**: **4.68** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/camel)
...
1.  Info about vulnerabilities: **20 vulnerabilities, [details below](#known-vulnerabilities)**
...
1763 commits in the last 3 months results to 10.00 points
20 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **1763**
1.  Number of contributors in the last three months: **20**
...
1.  Number of stars for a GitHub repository: **3776**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **JAVA, RUBY, JAVASCRIPT, OTHER**
