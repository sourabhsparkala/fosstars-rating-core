...
**Score**: **5.06**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **5.44** (weight is 1.0)
...
1.  **[Project activity](#project-activity)**: **4.91** (weight is 0.5)
1.  **[Project popularity](#project-popularity)**: **1.42** (weight is 0.5)
...
Score: **5.44**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **4.91**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

29 commits in the last 3 months results to 4.46 points
3 contributors increase the score value from 4.46 to 4.91
...
Score: **1.42**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1081**
