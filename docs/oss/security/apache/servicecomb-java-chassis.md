...
**Score**: **4.82**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **2.72** (weight is 1.0)
...
1.  **[Project activity](#project-activity)**: **6.26** (weight is 0.5)
1.  **[Project popularity](#project-popularity)**: **2.13** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/servicecomb-java-chassis)
...
Score: **2.72**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **6.26**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

37 commits in the last 3 months results to 5.69 points
3 contributors increase the score value from 5.69 to 6.26
...
Score: **2.13**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1710**
1.  Number of watchers for a GitHub repository: **126**
