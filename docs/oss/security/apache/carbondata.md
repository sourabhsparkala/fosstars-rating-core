...
**Score**: **4.6**, max score value is 10.0
...
1.  **[Project activity](#project-activity)**: **7.02** (weight is 0.5)
...
Score: **7.02**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

38 commits in the last 3 months results to 5.85 points
6 contributors increase the score value from 5.85 to 7.02
...
1.  Number of watchers for a GitHub repository: **129**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **CPP, JAVA, SCALA, C_SHARP, PYTHON, OTHER**
