...
**Score**: **4.54**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **0.8** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **1.84** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/trafficserver)
...
1.  Info about vulnerabilities: **36 vulnerabilities, [details below](#known-vulnerabilities)**
...
219 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **219**
1.  Number of contributors in the last three months: **1**

### Project popularity

Score: **1.84**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1310**
...
1.  [CVE-2018-8040](https://nvd.nist.gov/vuln/detail/CVE-2018-8040)
