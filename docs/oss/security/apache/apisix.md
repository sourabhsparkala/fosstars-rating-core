...
1.  **[Project popularity](#project-popularity)**: **6.08** (weight is 0.5)
...
Score: **0.0**, confidence is 9.78 (high), weight is 0.6 (medium)
...
Score: **6.08**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **5288**
1.  Number of watchers for a GitHub repository: **237**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **JAVA, PYTHON, GO, OTHER**
