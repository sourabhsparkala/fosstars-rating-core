...
**Score**: **4.53**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **1.11** (weight is 1.0)
...
Score: **1.11**, confidence is 10.0 (max), weight is 1.0 (high)
...
9 contributors increase the score value from 6.31 to 7.57
...
1.  Number of stars for a GitHub repository: **1914**
