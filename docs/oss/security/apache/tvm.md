...
**Score**: **5.62**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **1.96** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **8.12** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/tvm)
...
Score: **1.96**, confidence is 10.0 (max), weight is 1.0 (high)
...
436 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **436**
...
1.  Number of stars for a GitHub repository: **6853**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **C, CPP, JAVA, PYTHON, JAVASCRIPT, TYPESCRIPT, GO, OTHER**
...
1.  Does it use nohttp? **No**
1.  Package managers: **MAVEN, GRADLE, NPM, YARN**
