...
1.  **[Project popularity](#project-popularity)**: **6.44** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/jmeter)
...
3 contributors increase the score value from 8.15 to 8.97
...
Score: **6.44**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **5335**
1.  Number of watchers for a GitHub repository: **331**
