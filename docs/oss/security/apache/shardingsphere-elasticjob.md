...
**Score**: **5.65**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **5.12** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **9.22** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/shardingsphere-elasticjob)
...
Score: **5.12**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **2.0**, confidence is 10.0 (max), weight is 0.5 (medium)
...
Score: **9.22**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **7070**
1.  Number of watchers for a GitHub repository: **644**
