...
1.  **[Project activity](#project-activity)**: **6.43** (weight is 0.5)
1.  **[Project popularity](#project-popularity)**: **4.29** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/shiro)
...
Score: **6.43**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

38 commits in the last 3 months results to 5.85 points
4 contributors increase the score value from 5.85 to 6.43
...
Score: **4.29**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **3525**
1.  Number of watchers for a GitHub repository: **229**
