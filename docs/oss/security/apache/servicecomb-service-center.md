...
1.  **[Project popularity](#project-popularity)**: **1.51** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/servicecomb-service-center)
...
109 commits in the last 3 months results to 10.00 points
6 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **109**
1.  Number of contributors in the last three months: **6**

### Project popularity

Score: **1.51**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1248**
1.  Number of watchers for a GitHub repository: **79**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **JAVA, JAVASCRIPT, TYPESCRIPT, GO, OTHER**
