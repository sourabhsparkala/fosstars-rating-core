...
**Score**: **4.46**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **2.25** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/servicecomb-pack)
...
Score: **2.25**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1841**
1.  Number of watchers for a GitHub repository: **122**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **JAVA, JAVASCRIPT, TYPESCRIPT, OTHER**
