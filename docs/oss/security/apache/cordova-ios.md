...
**Score**: **3.84**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **2.11** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **2.64** (weight is 0.5)
...
Score: **2.11**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **2.64**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1996**
