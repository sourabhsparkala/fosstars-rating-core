...
**Score**: **5.16**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **3.12** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/calcite)
...
11 contributors increase the score value from 8.15 to 9.78
...
Score: **3.12**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **2540**
