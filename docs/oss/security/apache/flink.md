...
1.  **[Security testing](#security-testing)**: **2.62** (weight is 1.0)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/flink)
...
Score: **2.62**, confidence is 10.0 (max), weight is 1.0 (high)
...
881 commits in the last 3 months results to 10.00 points
28 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **881**
1.  Number of contributors in the last three months: **28**
...
1.  Number of stars for a GitHub repository: **16550**
1.  Number of watchers for a GitHub repository: **930**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **C, JAVA, SCALA, PYTHON, JAVASCRIPT, TYPESCRIPT, OTHER**
