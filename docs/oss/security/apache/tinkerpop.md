...
**Score**: **4.04**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **0.53** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **1.7** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/tinkerpop)
...
Score: **0.53**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **1.7**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1355**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **JAVA, C_SHARP, PYTHON, JAVASCRIPT, TYPESCRIPT, OTHER**
