...
**Score**: **4.71**, max score value is 10.0
...
1.  **[Project activity](#project-activity)**: **0.92** (weight is 0.5)
1.  **[Project popularity](#project-popularity)**: **8.29** (weight is 0.5)
...
Score: **0.92**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **6250**
1.  Number of watchers for a GitHub repository: **611**
