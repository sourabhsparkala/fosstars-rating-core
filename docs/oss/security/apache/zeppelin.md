...
**Score**: **5.54**, max score value is 10.0
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/zeppelin)
...
1.  Number of stars for a GitHub repository: **5307**
1.  Number of watchers for a GitHub repository: **340**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **JAVA, SCALA, PYTHON, JAVASCRIPT, TYPESCRIPT, OTHER**
