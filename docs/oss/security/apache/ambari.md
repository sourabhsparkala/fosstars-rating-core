...
**Score**: **3.82**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **2.17** (weight is 0.5)
...
Score: **2.17**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1517**
1.  Number of watchers for a GitHub repository: **195**
