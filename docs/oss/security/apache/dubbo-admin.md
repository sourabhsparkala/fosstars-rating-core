...
**Score**: **4.73**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **3.91** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/dubbo-admin)
...
Score: **3.91**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **3244**
1.  Number of watchers for a GitHub repository: **200**
