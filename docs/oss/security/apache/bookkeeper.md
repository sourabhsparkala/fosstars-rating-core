...
1.  **[Project activity](#project-activity)**: **8.24** (weight is 0.5)
1.  **[Project popularity](#project-popularity)**: **1.62** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/bookkeeper)
...
2 contributors increase the score value from 7.85 to 8.24
...
1.  Number of stars for a GitHub repository: **1296**
1.  Number of watchers for a GitHub repository: **97**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **C, CPP, JAVA, RUBY, PYTHON, JAVASCRIPT, OTHER**
