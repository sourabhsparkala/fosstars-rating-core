...
**Score**: **4.67**, max score value is 10.0
...
1.  **[Project activity](#project-activity)**: **4.52** (weight is 0.5)
1.  **[Project popularity](#project-popularity)**: **1.67** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/parquet-mr)
...
Score: **4.52**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

28 commits in the last 3 months results to 4.31 points
2 contributors increase the score value from 4.31 to 4.52
...
Score: **1.67**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1344**
1.  Number of watchers for a GitHub repository: **99**
