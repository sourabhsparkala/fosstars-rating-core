...
**Score**: **4.83**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **4.98** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/groovy)
...
288 commits in the last 3 months results to 10.00 points
7 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **288**
1.  Number of contributors in the last three months: **7**

### Project popularity

Score: **4.98**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **4193**
