...
1.  **[Security testing](#security-testing)**: **3.73** (weight is 1.0)
...
Score: **3.73**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  Info about vulnerabilities: **16 vulnerabilities, [details below](#known-vulnerabilities)**
...
1.  Does it use nohttp? **No**
1.  Package managers: **MAVEN, GRADLE, NPM, YARN, RUBYGEMS, COMPOSER**
