...
**Score**: **5.08**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **3.2** (weight is 1.0)
...
1.  **[Project activity](#project-activity)**: **5.98** (weight is 0.5)
1.  **[Project popularity](#project-popularity)**: **4.15** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/cordova-android)
...
Score: **3.2**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **5.98**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

37 commits in the last 3 months results to 5.69 points
2 contributors increase the score value from 5.69 to 5.98
...
Score: **4.15**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **3201**
1.  Number of watchers for a GitHub repository: **284**
...
1.  Does it use nohttp? **No**
1.  Package managers: **GRADLE, NPM, YARN**
