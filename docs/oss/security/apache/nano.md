...
**Score**: **4.05**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **2.8** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **1.26** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/nano)
...
Score: **1.26**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1125**
1.  Number of watchers for a GitHub repository: **41**
