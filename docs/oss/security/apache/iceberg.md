...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/iceberg)
...
1.  Number of stars for a GitHub repository: **1682**
1.  Number of watchers for a GitHub repository: **110**
