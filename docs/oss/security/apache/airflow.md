...
1.  **[Security testing](#security-testing)**: **6.4** (weight is 1.0)
    ...
    1.  **[Static analysis](#static-analysis)**: **6.0** (weight is 1.0)
...
Score: **6.4**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  Info about vulnerabilities: **24 vulnerabilities, [details below](#known-vulnerabilities)**
...
742 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **742**
...
1.  Number of stars for a GitHub repository: **22179**
1.  Number of watchers for a GitHub repository: **744**
...
1.  [CVE-2018-20245](https://nvd.nist.gov/vuln/detail/CVE-2018-20245)
