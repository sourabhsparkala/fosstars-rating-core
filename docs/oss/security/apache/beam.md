...
**Score**: **3.76**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **0.0** (weight is 1.0)
    ...
    1.  **[Static analysis](#static-analysis)**: **0.0** (weight is 1.0)
        1.  **[LGTM score](#lgtm-score)**: **unknown** (weight is 1.0)
...
1.  You can open a pull request to enable CodeQL scans in the project. Make sure that the scans are run on pull requests.
    More info:
...
2.  You can open a pull request to enable CodeQL scans in the project.
    More info:
...
Score: **0.0**, confidence is 4.74 (low), weight is 1.0 (high)
...
Score: **3.0**, confidence is 8.24 (low), weight is 0.9 (high)
...
Score: **0.0**, confidence is 7.37 (low), weight is 0.6 (medium)
...
1021 commits in the last 3 months results to 10.00 points
62 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **1021**
1.  Number of contributors in the last three months: **62**

### Project popularity

Score: **0.0**, confidence is 0.0 (min), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **unknown**
1.  Number of watchers for a GitHub repository: **unknown**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **unknown**

### Memory-safety testing

Score: **0.0**, confidence is 7.5 (low), weight is 1.0 (high)
...
Score: **0.0**, confidence is 3.0 (low), weight is 1.0 (high)
...
Score: **0.0**, confidence is 5.0 (low), weight is 0.5 (medium)
...
Score: **0.0**, confidence is 0.0 (min), weight is 1.0 (high)
...
1.  Does it use Dependabot? **unknown**
1.  Does it use GitHub as the main development platform? **unknown**
1.  Package managers: **unknown**
1.  Programming languages: **unknown**

### OWASP Dependency Check score

Score: **0.0**, confidence is 6.67 (low), weight is 1.0 (high)
