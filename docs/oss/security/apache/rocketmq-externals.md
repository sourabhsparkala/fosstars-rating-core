...
1.  **[Project popularity](#project-popularity)**: **4.52** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/rocketmq-externals)
...
1.  Number of stars for a GitHub repository: **3671**
1.  Number of watchers for a GitHub repository: **254**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **JAVA, SCALA, PYTHON, JAVASCRIPT, GO, OTHER**
