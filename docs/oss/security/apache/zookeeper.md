...
1.  **[Security testing](#security-testing)**: **2.4** (weight is 1.0)
    1.  **[Dependency testing](#dependency-testing)**: **10.0** (weight is 1.0)
        ...
        1.  **[OWASP Dependency Check score](#owasp-dependency-check-score)**: **10.0** (weight is 1.0)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/zookeeper)
...
1.  How is OWASP Dependency Check used? **Mandatory**
1.  Package managers: **MAVEN**
1.  What is the threshold for OWASP Dependency Check? **0.0**
