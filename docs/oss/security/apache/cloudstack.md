...
1.  **[Security testing](#security-testing)**: **3.92** (weight is 1.0)
    1.  **[Dependency testing](#dependency-testing)**: **9.0** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **1.48** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/cloudstack)
...
1.  Info about vulnerabilities: **15 vulnerabilities, [details below](#known-vulnerabilities)**
...
233 commits in the last 3 months results to 10.00 points
4 contributors increase the score value from 10.00 to 11.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **233**
1.  Number of contributors in the last three months: **4**

### Project popularity

Score: **1.48**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1028**
1.  Number of watchers for a GitHub repository: **135**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **JAVA, C_SHARP, RUBY, PYTHON, JAVASCRIPT, OTHER**
...
1.  Does it use nohttp? **No**
1.  Package managers: **MAVEN, NPM, YARN, DOTNET**
