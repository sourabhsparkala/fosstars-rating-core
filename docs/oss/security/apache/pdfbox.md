...
**Score**: **4.57**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **1.73** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/pdfbox)
...
300 commits in the last 3 months results to 10.00 points
4 contributors increase the score value from 10.00 to 11.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **300**
1.  Number of contributors in the last three months: **4**

### Project popularity

Score: **1.73**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1449**
