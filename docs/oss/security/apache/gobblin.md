...
1.  **[Project popularity](#project-popularity)**: **2.5** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/gobblin)
...
8 contributors increase the score value from 9.08 to 10.89
...
Score: **2.5**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1928**
1.  Number of watchers for a GitHub repository: **172**
