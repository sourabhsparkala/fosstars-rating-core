...
**Score**: **4.28**, max score value is 10.0
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/apache/mahout)
...
1.  Number of stars for a GitHub repository: **1933**
1.  Number of watchers for a GitHub repository: **240**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **JAVA, SCALA, RUBY, JAVASCRIPT, OTHER**
...
1.  Does it use nohttp? **No**
1.  Package managers: **MAVEN, RUBYGEMS**
