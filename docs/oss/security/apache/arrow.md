...
**Score**: **4.61**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **2.22** (weight is 1.0)
...
Score: **2.22**, confidence is 4.74 (low), weight is 1.0 (high)
...
Score: **4.0**, confidence is 8.24 (low), weight is 0.9 (high)
...
583 commits in the last 3 months results to 10.00 points
23 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **583**
...
Score: **10.0**, confidence is 5.0 (low), weight is 1.0 (high)
