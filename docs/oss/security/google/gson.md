...
1.  **[Project activity](#project-activity)**: **4.2** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/google/gson)
...
Score: **4.2**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

26 commits in the last 3 months results to 4.00 points
2 contributors increase the score value from 4.00 to 4.20
...
1.  Number of stars for a GitHub repository: **19719**
1.  Number of watchers for a GitHub repository: **754**
