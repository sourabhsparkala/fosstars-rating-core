...
1.  **[Security testing](#security-testing)**: **5.07** (weight is 1.0)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/google/flatbuffers)
...
Score: **5.07**, confidence is 10.0 (max), weight is 1.0 (high)
...
89 commits in the last 3 months results to 10.00 points
2 contributors increase the score value from 10.00 to 10.50

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **89**
...
1.  Number of stars for a GitHub repository: **16431**
1.  Number of watchers for a GitHub repository: **647**
...
1.  Is it included to OSS-Fuzz? **Yes**
1.  Programming languages: **C, CPP, JAVA, C_SHARP, PHP, RUBY, PYTHON, JAVASCRIPT, TYPESCRIPT, GO, OTHER**
...
1.  Does it use nohttp? **No**
1.  Package managers: **MAVEN, GRADLE, NPM, YARN, DOTNET, COMPOSER**
