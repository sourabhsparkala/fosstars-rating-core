...
**Score**: **6.0**, max score value is 10.0
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/google/guava)
...
120 commits in the last 3 months results to 10.00 points

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **120**
...
1.  Number of stars for a GitHub repository: **41555**
1.  Number of watchers for a GitHub repository: **2475**
...
1.  [CVE-2018-10237](https://nvd.nist.gov/vuln/detail/CVE-2018-10237)
1.  [CVE-2020-8908](https://nvd.nist.gov/vuln/detail/CVE-2020-8908)
