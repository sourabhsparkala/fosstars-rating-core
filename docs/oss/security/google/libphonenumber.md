...
**Score**: **5.36**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **4.44** (weight is 1.0)
...
1.  Number of stars for a GitHub repository: **12202**
1.  Number of watchers for a GitHub repository: **389**
...
1.  Is it included to OSS-Fuzz? **Yes**
1.  Programming languages: **C, CPP, JAVA, JAVASCRIPT, OTHER**
