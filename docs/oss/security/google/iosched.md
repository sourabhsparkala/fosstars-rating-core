...
**Score**: **4.9**, max score value is 10.0
...
63 commits in the last 3 months results to 9.69 points
8 contributors increase the score value from 9.69 to 11.63

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **63**
...
1.  Number of stars for a GitHub repository: **20572**
1.  Number of watchers for a GitHub repository: **1483**
