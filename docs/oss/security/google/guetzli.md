...
**Score**: **4.85**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **3.86** (weight is 1.0)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/google/guetzli)
...
Score: **3.86**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  Number of stars for a GitHub repository: **12568**
...
1.  Is it included to OSS-Fuzz? **Yes**
1.  Programming languages: **CPP, PHP, PYTHON, OTHER**
