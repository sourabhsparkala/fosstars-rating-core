...
1.  **[Security testing](#security-testing)**: **0.23** (weight is 1.0)
...
1.  **[Project activity](#project-activity)**: **1.45** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/google/mediapipe)
...
Score: **0.23**, confidence is 10.0 (max), weight is 1.0 (high)
...
2 contributors increase the score value from 1.38 to 1.45
...
1.  Number of stars for a GitHub repository: **12798**
