...
1.  **[Security testing](#security-testing)**: **0.67** (weight is 1.0)
...
1.  **[Project activity](#project-activity)**: **6.83** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/google/cadvisor)
...
Score: **0.67**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **6.83**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

37 commits in the last 3 months results to 5.69 points
11 contributors increase the score value from 5.69 to 6.83
...
1.  Number of stars for a GitHub repository: **12256**
1.  Number of watchers for a GitHub repository: **399**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **PYTHON, JAVASCRIPT, GO, OTHER**
