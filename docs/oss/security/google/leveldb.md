...
1.  **[Security testing](#security-testing)**: **4.14** (weight is 1.0)
...
1.  **[Project activity](#project-activity)**: **0.65** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/google/leveldb)
...
Score: **4.14**, confidence is 10.0 (max), weight is 1.0 (high)
...
2 contributors increase the score value from 0.62 to 0.65
...
1.  Number of stars for a GitHub repository: **25620**
1.  Number of watchers for a GitHub repository: **1333**
...
1.  Is it included to OSS-Fuzz? **Yes**
1.  Programming languages: **C, CPP, OTHER**
