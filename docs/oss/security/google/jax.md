...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/google/jax)
...
882 commits in the last 3 months results to 10.00 points
51 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **882**
1.  Number of contributors in the last three months: **51**
...
1.  Number of stars for a GitHub repository: **13161**
