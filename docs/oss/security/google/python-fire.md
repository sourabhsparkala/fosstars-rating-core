...
1.  **[Security testing](#security-testing)**: **3.0** (weight is 1.0)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/google/python-fire)
...
1.  Number of stars for a GitHub repository: **19713**
1.  Number of watchers for a GitHub repository: **377**
