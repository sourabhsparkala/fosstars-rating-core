...
1.  **[Security testing](#security-testing)**: **4.89** (weight is 1.0)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/google/brotli)
...
Score: **4.89**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  Number of stars for a GitHub repository: **10143**
1.  Number of watchers for a GitHub repository: **349**
...
1.  Is it included to OSS-Fuzz? **Yes**
1.  Programming languages: **C, CPP, JAVA, C_SHARP, PYTHON, JAVASCRIPT, GO, OTHER**
