...
**Score**: **5.43**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **2.01** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/eclipse/eclipse-collections)
...
6 contributors increase the score value from 4.46 to 5.35
...
Score: **2.01**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1711**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **JAVA, SCALA, OTHER**
