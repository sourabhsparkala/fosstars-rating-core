...
**Score**: **3.87**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **1.56** (weight is 1.0)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/eclipse/mraa)
...
Score: **1.56**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  Number of stars for a GitHub repository: **1226**
1.  Number of watchers for a GitHub repository: **132**
