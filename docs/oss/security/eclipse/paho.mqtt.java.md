...
1.  **[Project popularity](#project-popularity)**: **1.89** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/eclipse/paho.mqtt.java)
...
Score: **1.89**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1514**
