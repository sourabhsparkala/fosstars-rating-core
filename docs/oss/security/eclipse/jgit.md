...
1.  **[Project popularity](#project-popularity)**: **1.25** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/eclipse/jgit)
...
119 commits in the last 3 months results to 10.00 points
11 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **119**
1.  Number of contributors in the last three months: **11**

### Project popularity

Score: **1.25**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1018**
1.  Number of watchers for a GitHub repository: **71**
...
1.  [CVE-2014-9390](https://nvd.nist.gov/vuln/detail/CVE-2014-9390)
