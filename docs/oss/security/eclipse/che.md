...
**Score**: **6.2**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **6.0** (weight is 1.0)
...
1.  **[Project popularity](#project-popularity)**: **7.49** (weight is 0.5)
...
Score: **7.49**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **6457**
1.  Number of watchers for a GitHub repository: **309**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **TYPESCRIPT, OTHER**
