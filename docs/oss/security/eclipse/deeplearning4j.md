...
541 commits in the last 3 months results to 10.00 points
9 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **541**
...
1.  Number of stars for a GitHub repository: **12088**
1.  Number of watchers for a GitHub repository: **807**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **C, CPP, JAVA, SCALA, C_SHARP, RUBY, PYTHON, JAVASCRIPT, TYPESCRIPT, OTHER**
