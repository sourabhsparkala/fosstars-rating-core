...
**Score**: **4.19**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **1.29** (weight is 1.0)
...
1.  **[Project activity](#project-activity)**: **4.31** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/eclipse/paho.mqtt.c)
...
Score: **1.29**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **4.31**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

28 commits in the last 3 months results to 4.31 points
...
1.  Number of stars for a GitHub repository: **1134**
1.  Number of watchers for a GitHub repository: **100**
