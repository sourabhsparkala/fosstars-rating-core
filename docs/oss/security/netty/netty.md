...
**Score**: **6.4**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **5.11** (weight is 1.0)
...
3.  You can open a pull request to enable AddressSanitizer for the project.
    More info:
    1.  [About AddressSanitizer](https://github.com/google/sanitizers/wiki/AddressSanitizer)
4.  You can open a pull request to enable MemorySanitizer for the project.
    More info:
    1.  [About MemorySanitizer](https://github.com/google/sanitizers/wiki/MemorySanitizer)
5.  You can open a pull request to enable UndefinedBehaviorSanitizer for the project.
    More info:
    1.  [About UndefinedBehaviorSanitizer](https://clang.llvm.org/docs/UndefinedBehaviorSanitizer.html)
6.  You can include the project to OSS-Fuzz. Then, the project is going to be regularly fuzzed.
    More info:
...
Score: **5.11**, confidence is 10.0 (max), weight is 1.0 (high)
...
1.  Number of stars for a GitHub repository: **26727**
1.  Number of watchers for a GitHub repository: **1827**
