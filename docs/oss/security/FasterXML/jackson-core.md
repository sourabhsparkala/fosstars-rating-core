...
**Score**: **3.43**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **2.47** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/FasterXML/jackson-core)
5.  You can open a pull request to add a security policy for the project.
    ...
    3.  [Suggest a security policy for the project](https://github.com/FasterXML/jackson-core/security/policy)
6.  You can open a pull request to enable FindSecBugs for the project.
    More info:
    1.  [FindSecBugs home page](https://find-sec-bugs.github.io/)
7.  You can configure Dependabot by creating a configuration file.
    More info:
...
Score: **2.47**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1952**
1.  Number of watchers for a GitHub repository: **154**
