...
**Score**: **2.75**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **7.85** (weight is 0.5)
...
Score: **7.85**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **6672**
1.  Number of watchers for a GitHub repository: **352**
