...
1.  **[Project popularity](#project-popularity)**: **3.38** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/FasterXML/jackson-databind)
...
1.  Info about vulnerabilities: **64 vulnerabilities, [details below](#known-vulnerabilities)**
...
88 commits in the last 3 months results to 10.00 points
2 contributors increase the score value from 10.00 to 10.50

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **88**
...
1.  Number of stars for a GitHub repository: **2850**
