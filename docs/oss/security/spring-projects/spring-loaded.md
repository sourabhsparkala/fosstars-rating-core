...
**Score**: **3.7**, max score value is 10.0
...
1.  **[Security testing](#security-testing)**: **0.32** (weight is 1.0)
...
1.  **[Project activity](#project-activity)**: **0.85** (weight is 0.5)
1.  **[Project popularity](#project-popularity)**: **3.25** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/spring-projects/spring-loaded)
...
Score: **0.32**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **0.85**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

5 commits in the last 3 months results to 0.77 points
3 contributors increase the score value from 0.77 to 0.85

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **5**
1.  Number of contributors in the last three months: **3**

### Project popularity

Score: **3.25**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **2565**
1.  Number of watchers for a GitHub repository: **206**
