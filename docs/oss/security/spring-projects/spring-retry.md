...
1.  **[Security testing](#security-testing)**: **4.8** (weight is 1.0)
...
1.  **[Project activity](#project-activity)**: **1.35** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/spring-projects/spring-retry)
...
Score: **1.35**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

8 commits in the last 3 months results to 1.23 points
4 contributors increase the score value from 1.23 to 1.35
...
1.  Number of stars for a GitHub repository: **1516**
