...
1.  **[Project activity](#project-activity)**: **3.23** (weight is 0.5)
1.  **[Project popularity](#project-popularity)**: **2.69** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/spring-projects/spring-batch)
...
Score: **3.23**, confidence is 10.0 (max), weight is 0.5 (medium)
...
Score: **2.69**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **1859**
