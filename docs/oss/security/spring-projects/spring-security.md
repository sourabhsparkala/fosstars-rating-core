...
1.  **[Project popularity](#project-popularity)**: **7.53** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/spring-projects/spring-security)
...
289 commits in the last 3 months results to 10.00 points
9 contributors increase the score value from 10.00 to 12.00

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **289**
1.  Number of contributors in the last three months: **9**

### Project popularity

Score: **7.53**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **6030**
1.  Number of watchers for a GitHub repository: **449**
...
1.  Is it included to OSS-Fuzz? **No**
1.  Programming languages: **JAVA, PYTHON, JAVASCRIPT, OTHER**
...
1.  [CVE-2016-9879](https://nvd.nist.gov/vuln/detail/CVE-2016-9879)
1.  [CVE-2014-3527](https://nvd.nist.gov/vuln/detail/CVE-2014-3527)
1.  [CVE-2017-4995](https://nvd.nist.gov/vuln/detail/CVE-2017-4995)
1.  [CVE-2018-1199](https://nvd.nist.gov/vuln/detail/CVE-2018-1199)
1.  [CVE-2018-1258](https://nvd.nist.gov/vuln/detail/CVE-2018-1258)
1.  [CVE-2019-3795](https://nvd.nist.gov/vuln/detail/CVE-2019-3795)
1.  [CVE-2019-11272](https://nvd.nist.gov/vuln/detail/CVE-2019-11272)
1.  [CVE-2020-5407](https://nvd.nist.gov/vuln/detail/CVE-2020-5407)
1.  [CVE-2020-5408](https://nvd.nist.gov/vuln/detail/CVE-2020-5408)
1.  [CVE-2021-22112](https://nvd.nist.gov/vuln/detail/CVE-2021-22112)
