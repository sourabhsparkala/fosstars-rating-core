...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/spring-projects/spring-data-mongodb)
...
4 contributors increase the score value from 8.92 to 9.82
...
1.  Number of stars for a GitHub repository: **1299**
