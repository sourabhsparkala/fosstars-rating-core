...
1.  **[Security testing](#security-testing)**: **4.72** (weight is 1.0)
...
1.  **[Project activity](#project-activity)**: **1.23** (weight is 0.5)
1.  **[Project popularity](#project-popularity)**: **5.76** (weight is 0.5)
...
Score: **4.72**, confidence is 10.0 (max), weight is 1.0 (high)
...
Score: **1.23**, confidence is 10.0 (max), weight is 0.5 (medium)
...
Score: **5.76**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **4409**
1.  Number of watchers for a GitHub repository: **404**
...
1.  [CVE-2016-4977](https://nvd.nist.gov/vuln/detail/CVE-2016-4977)
1.  [CVE-2018-1260](https://nvd.nist.gov/vuln/detail/CVE-2018-1260)
1.  [CVE-2018-15758](https://nvd.nist.gov/vuln/detail/CVE-2018-15758)
1.  [CVE-2019-3778](https://nvd.nist.gov/vuln/detail/CVE-2019-3778)
1.  [CVE-2019-11269](https://nvd.nist.gov/vuln/detail/CVE-2019-11269)
