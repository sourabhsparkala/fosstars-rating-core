...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/spring-projects/spring-session)
...
3 contributors increase the score value from 5.08 to 5.58
...
1.  Number of stars for a GitHub repository: **1609**
