...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/spring-projects/spring-statemachine)
...
1.  Number of stars for a GitHub repository: **1123**
1.  Number of watchers for a GitHub repository: **98**
