...
1.  **[Project popularity](#project-popularity)**: **6.18** (weight is 0.5)
...
Score: **6.18**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **4931**
1.  Number of watchers for a GitHub repository: **376**
