...
**Score**: **5.1**, max score value is 10.0
...
1.  **[Project popularity](#project-popularity)**: **2.8** (weight is 0.5)
...
4.  You can fix the issues reported by LGTM for the project.
    More info:
    1.  [List of issues on LGTM](https://lgtm.com/projects/g/spring-projects/spring-data-jpa)
...
4 contributors increase the score value from 6.15 to 6.77
...
Score: **2.8**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **2100**
1.  Number of watchers for a GitHub repository: **209**
